...
function CharacterArray(props){
    const {width, height, startingDatabase, relationsDatabase, seenCharacters} = props;
    ...
    return <g>
        ...
        <StaticNodes data={startingDatabase} relationsDatabase={relationsDatabase} currentCharacter={currentCharacter}setCurrentCharacter={setCurrentCharacter} seenCharacters={seenCharacters}/>
